...
{
    public class InboxMandateTab : SqlQueries
    {
        public InboxMandateTab(CancellationToken token) : base(token)
        {
        }

        public override string TableName => "IT125";
        public override string NewTableName => "InboxMandate";
