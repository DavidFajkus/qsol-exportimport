...
{
    public class TaskMandateTab : SqlQueries
    {
        public TaskMandateTab(CancellationToken token) : base(token)
        {
        }

        public override string TableName => "IT160";
        public override string NewTableName => "TaskMandate";
