...
{
    public class OutboxPCBTab : SqlQueries
    {
        public OutboxPCBTab(CancellationToken token) : base(token)
        {
        }

        public override string TableName => "IT128";
        public override string NewTableName => "OutboxPCB";
