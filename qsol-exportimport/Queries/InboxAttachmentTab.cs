...
{
    public class InboxAttachmentTab : SqlQueries
    {
        public InboxAttachmentTab(CancellationToken token) : base(token)
        {
        }

        public override string TableName => "IT099";
        public override string NewTableName => "InboxAttachment";
