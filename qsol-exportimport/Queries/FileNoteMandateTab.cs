...
{
    public class FileNoteMandateTab : SqlQueries
    {
        public FileNoteMandateTab(CancellationToken token) : base(token)
        {
        }

        public override string TableName => "IT173";
        public override string NewTableName => "FileNoteMandate";
