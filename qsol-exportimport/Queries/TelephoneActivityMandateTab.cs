...
{
    public class TelephoneActivityMandateTab : SqlQueries
    {
        public TelephoneActivityMandateTab(CancellationToken token) : base(token)
        {
        }

        public override string TableName => "IT157";
        public override string NewTableName => "TelephoneActivityMandate";
