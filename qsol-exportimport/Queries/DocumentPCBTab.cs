...
{
    public class DocumentPCBTab : SqlQueries
    {
        public DocumentPCBTab(CancellationToken token) : base(token)
        {
        }

        public override string TableName => "IT146";
        public override string NewTableName => "DocumentPCB";
