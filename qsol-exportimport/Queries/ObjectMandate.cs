...
{
    public class ObjectMandateTab : SqlQueries
    {
        public ObjectMandateTab(CancellationToken token) : base(token)
        {
        }

        public override string TableName => "IT322";
        public override string NewTableName => "ObjectMandate";
