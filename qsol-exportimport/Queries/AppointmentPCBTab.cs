...
{
    public class AppointmentPCBTab : SqlQueries
    {
        public AppointmentPCBTab(CancellationToken token) : base(token)
        {
        }

        public override string TableName => "IT130";
        public override string NewTableName => "AppointmentPCB";
