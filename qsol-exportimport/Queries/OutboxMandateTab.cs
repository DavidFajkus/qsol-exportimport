...
{
    public class OutboxMandateTab : SqlQueries
    {
        public OutboxMandateTab(CancellationToken token) : base(token)
        {
        }

        public override string TableName => "IT127";
        public override string NewTableName => "OutboxMandate";
        protected override int ColCount => 3;
        protected override string ColShortcut => "IT";

        private readonly string nc01 = "OutboxId";
        private readonly string nc02 = "MandateId";
        private readonly string nc03 = "Manually";
